...
swift test --filter 'NavigationTests|PermitTests|FileSelectionTests|SuperUploadPlanTests|LocalStoreTests|DraftAndTemplateTests' 2>&1 | tee test-results/core-tests.txt
